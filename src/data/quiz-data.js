...
const QUESTION_DATA = [
  {
    question: <span>What is a blockchain?</span>,
    answers: [
      <span>A Buzzword </span>,
      <span>Blocks tied together using unbreakable chains</span>,
      <span>An open decentralized database to record assets and transactions</span>,
      <span>New type of Legos</span>
    ],
    correct: 2 
  },
  {
    question: <span>How do people send money today? </span>,
    answers: [
      <span>Using 3rd Party such as a Bank</span>,
      <span>Using Peer to Peer networks</span>,
      <span>By Hand </span>,
      <span>N/A</span>
    ],
    correct: 0
  ...
  {
    question: <span>What is a peer to peer network? </span>,
    answers: [
      <span>A network for Peers and 3rd parties </span>,
      <span>A type of WIFI </span>,
      <span>Network designed for two without a middleman</span>,
      <span>All of the above.</span>
    ],
    correct: 2
  },
  {
    question: <span>Who can participate in the blockchain network?</span>,
    answers: [
      <span>Anyone selected and approved  </span>,
      <span>Anyone with a Bank account</span>,
      <span>Anyone with access to the Internet </span>,
      <span>All of the above.</span>
    ],
    correct: 2
  },
  {
    question: <span>Why are current financial systems wary of blockchain?</span>,
    answers: [
      <span>They do not believe the technology is necessary </span>,
      <span>The current financial system is perfect the way it is </span>,
      <span>New possibilities allow people to bypass the traditional financial system </span>,
      <span>They have bigger problems to worry about</span>
    ],
    correct: 2
  },
  {
    question: <span>How is trust different in blockchain systems in comparison to current systems?</span>,
    answers: [
      <span>No difference between old systems and new systems</span>,
      <span>Trust is gained over a period of time</span>,
      <span>Trust is coded in the software rather than given to a 3rd Parties</span>,
      <span>Humans are more trustworthy than computers </span>
    ],
    correct: 2
  },
  {
    question: <span>How is a transaction verified?</span>,
    answers: [
      <span>3rd Party Services</span>,
      <span>It does not get verified</span>,
      <span>Computer’s solve a mathematical algorithm and share it with other computers</span>,
      <span>Humans record the transaction</span>
    ],
    correct: 2
  },
  {
    question: <span>Who verifies transactions in the network?</span>,
    answers: [
      <span>Banks</span>,
      <span>Humans</span>,
      <span>Computers on the network</span>,
      <span>No verification needed</span>
    ],
    correct: 2
  },
  {
    question: <span>Who faces the most imminent danger of blockchain?</span>,
    answers: [
      <span>Producers</span>,
      <span>Consumers</span>,
      <span>3rd Party Trust services</span>,
      <span>Robots</span>
    ],
    correct: 2
  },
  {
    question: <span>What are the main benefits of blockchain technology?</span>,
    answers: [
      <span>No Real benefit</span>,
      <span>Looks good on a resume</span>,
      <span>Cheaper and more efficient way to record data and interact with assets </span>,
      <span>New Lego blocks!</span>
    ],
    correct: 2
  },
  // {
